...
class DoctorEmailMailable extends Mailable
{
    ...
    public function build()
    {
        ...
        } else if ($this->type == 'doctor_email_payout_processing') {
            $email_message = $this->prepareDoctorEmailPayoutProcessing($this->email_params);
        } else if ($this->type == 'doctor_email_payout_processed') {
            $email_message = $this->prepareDoctorEmailPayoutProcessed($this->email_params);
        } 
    ...
    /**
     * Email Doctor Payout Start Processing
     *
     * @param array $email_params Email Parameters
     *
     * @access public
     ...
     * @return string
     */
    public function prepareDoctorEmailPayoutProcessing($email_params)
    {
        extract($email_params);
        $doctor = $doctor_name;
        $amount = $total_amount;
        ...
        $app_content = str_replace("%doctor_name%", $doctor, $app_content);
        $app_content = str_replace("%total_amount%", $amount, $app_content);
        $app_content = str_replace("%signature%", $signature, $app_content);
     ...
     * @return string
     */
    public function prepareDoctorEmailPayoutProcessed($email_params)
    {
        extract($email_params);
        $doctor = $doctor_name;
        $amount = $total_amount;
