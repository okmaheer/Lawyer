...
import { Calendar, Slider } from 'ant-design-vue'
...
Vue.component('booking-num', require('./components/BookingNumbersComponent.vue').default)
...
Vue.component('page-listing', require('./components/pages/index.vue').default)
Vue.component('page-create', require('./components/pages/create.vue').default)
Vue.component('page-edit', require('./components/pages/edit.vue').default)
Vue.component('show-page', require('./components/pages/show/show.vue').default)
...
Vue.component('edit-slider', require('./components/EditSliderComponent.vue').default)
Vue.component('page-order', require('./components/PageOrderComponent.vue').default);
Vue.component('inner-page-order', require('./components/InnerPagesOrderComponent.vue').default);
Vue.component('custom-link', require('./components/CustomLinkComponent.vue').default);
Vue.component('common-issue', require('./components/CommonIssueComponent.vue').default);
Vue.component('medication-component', require('./components/MedicationComponent.vue').default);
Vue.component('add-appointment-component', require('./components/doctorAppointments/AddAppointmentComponent.vue').default);
...
document.onreadystatechange = function () {
    if (document.readyState === 'complete') {
        ...
        if (url != APP_URL + '/' || url != APP_URL + '/page/' + last_part + '/') {
...
if (document.getElementById("health_forum")) {
    const vmhealth_forum = new Vue({
        el: '#health_forum',
        mounted: function () {
        ...
        methods: {
            ...
            updateAnswer: function (id, elementID) {
                let answer = document.getElementById(elementID) ? document.getElementById(elementID).value : ''
                var self = this
                axios.post(APP_URL + '/admin/answer/update', {
                    id: id,
                    answer: answer
                })
                    .then(function (response) {
                    ...
                    .catch(function (error) {
                        if (error.response.data.errors.answer) {
                            self.showError(error.response.data.errors.answer[0])
                        }
                    })
            },
            displayAnswer: function (reference) {
                this.$refs[reference].show();
            },
            selectAll: function () {
                this.is_show = !this.is_show
                jQuery('#dc-forums').change(function () {
...
if (document.getElementById("sliders")) {
    const vmpassReset = new Vue({
        ...
        created: function () {
            ...
            if (pageSlug == 'edit') {
                var last_part = parts[parts.length - 1]
                this.getSliderType(last_part)
                this.getSearchFormSetting(last_part)
            }
        },
        data: {
        ...
        methods: {
            ...
            removeStoredSlide: function (element_id) {
                jQuery('#' + element_id).remove();
            },
            getSliderType: function (id) {
                let self = this;
                axios.get(APP_URL + '/slider/get-slider-type/' + id)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.selectedStyle = response.data.style;
                        }
                    });
            },
            getSearchFormSetting: function (id) {
                let self = this;
                axios.get(APP_URL + '/slider/get-search-setting/' + id)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            if (response.data.search_form == 'true') {
            ...
            selectAll: function () {
                this.is_show = !this.is_show
                jQuery('#dc-sliders').change(function () {
                    jQuery('input:checkbox').prop('checked', jQuery(this).prop('checked'))
                })
            },
            selectRecord: function () {
                    ...
                    .then(function (response) {
                        ...
                        if (response.data.type === 'success') {
                            if (response.data.email === 'not_configured') {
                                ...
                                if (response.data.verification_step == true || response.data.verification_step == 'true') {
                                    self.next()
...
if (document.getElementById('settings')) {
    const settings = new Vue({
        ...
        data: {
            ...
            show_forum_menu: true,
            show_article_menu: true,
            show_search_menu: true,
            enable_call_appointment: true,
            enable_booking_verification: true,
            enable_booking_private_clinic: false,
            ...
            menu_color: '#3d4461',
            menu_hover_color: '#3fabf3',
            color: '#3d4461',
            show_menu_color: false,
            enable_color_text: '',
            ...
            language: 'en',
            colorSettings: true,
            show_search_list_header_styling: false,
            show_forum_header_styling: false,
            show_article_header_styling: false,
            searchHeaderStyling: {
                textColor: '',
                menuColor: '',
                HoverColor: '',
        ...
        created: function () {
            ...
            this.geRegistrationTypeSettings()
        },
        methods: {
            geRegistrationTypeSettings: function () {
                let self = this
                axios.get(APP_URL + '/admin/get-registration-type-settings')
                    .then(function (response) {
                        if (response.data.registration_type) {
                            self.reg_form_type = response.data.registration_type
                        }
                        if (response.data.enable_verification == 'true') {
            ...
            submitRegFormSettings: function () {
                ...
                formData.append('enable_verification', this.enable_verification)
                var self = this
            ...
            getBookingSwitchSettings: function () {
                ...
                axios.get(APP_URL + '/admin/get-booking-switch-settings')
                    .then(function (response) {
                        ...
                        if ((response.data.enable_booking_verification === 'true')) {
                            self.enable_booking_verification = true
                        } else {
                            self.enable_booking_verification = false
                        }
                        if ((response.data.enable_call_appointment === 'true')) {
                            self.enable_call_appointment = true
                        } else {
                            self.enable_call_appointment = false
                        }
                        if ((response.data.enable_booking_private_clinic === 'true')) {
                            self.enable_booking_private_clinic = true
                        } else {
                            self.enable_booking_private_clinic = false
                        }
                    })
            },
            ...
            submitHomepageSettings: function () {
                let settings_form = document.getElementById('homepaeg-setting-form');
                let form_data = new FormData(settings_form);
                var self = this;
                axios.post(APP_URL + '/admin/store/homepage-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.progressing);
                            self.success_message = response.data.message;
            ...
            getInnerPageSettings: function () {
                ...
                axios.post(APP_URL + '/admin/get/innerpage-settings')
                    .then(function (response) {
                        self.searchHeaderStyling.menuColor = response.data.search_menu_color
                        self.searchHeaderStyling.HoverColor = response.data.search_hover_color
                        self.searchHeaderStyling.textColor = response.data.search_menu_text_color
                        ...
                        self.forumHeaderStyling.menuColor = response.data.forum_menu_color
                        self.forumHeaderStyling.HoverColor = response.data.forum_hover_color
                        self.forumHeaderStyling.textColor = response.data.forum_menu_text_color
                        ...
                        if ((response.data.show_forum_menu == 'true')) {
                            self.show_forum_menu = true;
                        } else {
                            self.show_forum_menu = false;
                        }
                        if ((response.data.show_article_menu == 'true')) {
                            self.show_article_menu = true;
                        } else {
                            self.show_article_menu = false;
                        }
                        if ((response.data.show_search_menu == 'true')) {
                            self.show_search_menu = true;
                        } else {
                            self.show_search_menu = false;
                        }
                        if ((response.data.show_search_list_header_styling == 'true')) {
                            self.show_search_list_header_styling = true;
                        } else {
                            self.show_search_list_header_styling = false;
                        }
                        if ((response.data.show_article_header_styling == 'true')) {
                            self.show_article_header_styling = true;
                        } else {
                            self.show_article_header_styling = false;
                        }
                        if ((response.data.show_forum_header_styling == 'true')) {
                            self.show_forum_header_styling = true;
                        } else {
                            self.show_forum_header_styling = false;
                        }
                    });
            },
        }
...
if (document.getElementById('profile_settings')) {
    const VueProfileSettings = new Vue({
        ...
        methods: {
            ...
            submitDefaultLocation: function () {
                let defaultLocation = document.getElementById('submit-default-location')
                let formData = new FormData(defaultLocation)
                var self = this
                axios.post(APP_URL + '/doctor/store-default-location', formData)
                    .then(function (response) {
                        if (response.data.type === 'success') {
                            self.showInfo(response.data.progressing);
                            self.success_message = response.data.message;
                    ...
                    .catch(function (error) {
                        ...
                        if (error.response.data.errors.location) {
                            self.showError(error.response.data.errors.location[0])
                        }
                        if (error.response.data.errors.latitude) {
                            self.showError(error.response.data.errors.latitude[0])
                        }
...
if (document.getElementById('user-profile')) {
    const vueUserProfile = new Vue({
        ...
        created: function () {
            if (this.getUrlVars()['sort_by']) {
                this.sort_by = this.getUrlVars()['sort_by'];
            }
            if (this.getUrlVars()['order_by']) {
                this.order = this.getUrlVars()['order_by'];
            }
        },
        methods: {
            getUrlVars: function () {
            ...
            checkAppointmentStep1: function (doctorID) {
                ...
                if (patient == 'someone') {
                    ...
                    var relation = document.getElementById('relation').value ? document.getElementById('relation').value : ''
                    ...
                    if (isTimeSlot == true) {
                        ...
                        axios.post(APP_URL + '/store-appointment-data', formData)
                            .then(function (response) {
                                ...
                                self.appointment.other_relation = response.data.other_relation;
                                if (response.data.enable_booking_verification == true || response.data.enable_booking_verification == 'true') {
                                    self.next();
                                } else {
                                    self.submitAppointment(doctorID);
                                }
                            })
                    } else {
...
if (document.getElementById('appointment_locations')) {
    const vappointments = new Vue({
        ...
        data: {
            ...
            location_type: Vue.prototype.trans('lang.hospital'),
            end_time: null,
            is_show: false,
            loading: false,
            appointment_space: 1,
        ...
        methods: {
            ...
            submitAppointmentLocation: function () {
                ...
                let formData = new FormData(settingsSliderForm)
                if (this.location_type == 'hospital') {
                ...
                var self = this
                if ((self.location_type == 'hospital' && hospital) || start_time && (self.duration || self.duration != 'Select Duration')
                    ...
                    this.loading = false;
                    var form_errors = [];
                    if (this.location_type == 'hospital' && !hospital) form_errors.push(Vue.prototype.trans('lang.hospital_req'));
                        ...
                        axios.post(APP_URL + '/hospital/approve-user', {
                            ...
                            .then(function (response) {
                                if (response.data.type == 'success') {
                                    self.is_loading = false;
                                    self.$swal(final_msg, message, 'success')
                                    window.location.replace(APP_URL + '/hospital/manage-team')
                                } else {
                                    self.is_loading = false;
                                    self.showError(response.data.message);
                                }
                ...
                axios.post(APP_URL + '/admin/update-payout-status', {
                    ...
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showMessage(response.data.message);
                            self.loading = false;
                            document.getElementById(id + '-payout_status').style.pointerEvents = "none"
                        } else {
                            self.loading = false;
                            self.showError(response.data.message);
                        }
...
if (document.getElementById("prescription")) {
    const vmpassReset = new Vue({
        ...
        methods: {
            ...
            submitPrescriptionForm: function (appointment_id) {
                this.loading = true;
                let prescription_form = document.getElementById('dc-prescription-form');
                let data = new FormData(prescription_form);
                data.append('appointment_id', appointment_id)
                var self = this;
                axios.post(APP_URL + '/doctor/submit/prescription', data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.loading = false;
                            self.showMessage(response.data.message);
                            setTimeout(function () {
                                window.location.replace(APP_URL + '/doctor/appointments');
                            }, 2000);
                        } else if (response.data.type == 'error') {
                            self.loading = false;
                            self.showError(response.data.message);
