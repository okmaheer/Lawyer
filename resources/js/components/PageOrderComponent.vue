<template>
    <div>
        <div class="dc-formtheme dc-pagesorder dc-skillsform">
            ...
            <ul id="skill_list" class="sortable list">
                <li v-for="(stored_page, index) in storedPages" :key="index" v-if="storedPages" class="skill-element" :ref="'skill-'+index">
                    ...
                    <div class="dc-rightarea">
                        <a href="javascript:void(0);" id="dc-addinfo2" class="dc-addinfo" @click="editInput(index)"><i class="lnr lnr-pencil"></i></a>
                ...
                <li v-for="(pageItem, index) in pages" :key="index+page.count">
                    ...
                    <div class="dc-rightarea">
                        <a href="javascript:void(0);" id="dc-addinfo2" class="dc-addinfo"><i class="lnr lnr-pencil"></i></a>
...
<script>
 export default{
    props: ['widget_title', 'ph_rate_skills'],
        ...
        mounted: function () {
            jQuery(document).on('click', '#dc-addinfo2', function (e) {
                e.preventDefault();
                var _this = jQuery(this);
                _this.addClass('dc-skillsactive');
