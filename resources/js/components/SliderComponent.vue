            ...
            <li class="slide-inner-list" v-for="(stored_slide, index) in stored_slides" :key="'stored_'+index" v-if="stored_slides.length > 0">
                <div class="slide-inner-list-item dc-settingscontent" :id="'slide-element-'+index">
                    <updateHomeSlider
                        ...
                        :img_url="slide.url+'/media/upload-temp-image/sliders/slide'+index+'slide_inner_image'"
                        :stroed_img_url="slide.url+'/uploads/sliders/'+slider_id+'/'+stored_slide.hidden_slide_inner_image"
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <upload-media
                                        ...
                                        :url="slide.url+'/media/upload-temp-image/sliders/slide'+slide.count+'slide_inner_image'"
                                    >
                                    </upload-media>
                                </div>
                            </fieldset>
...
export default{
    ...
    props: [
            'upload_url', 'ph_slide_title_one', 'ph_slide_title_two', 
            'ph_slide_title_three', 'ph_slide_btn_title_one', 'ph_slide_btn_url_one', 
            'ph_slide_btn_title_two', 'ph_slide_btn_url_two', 'component', 'slider_id',
              'section_sliders'
        ],
        data(){
            return {
                // stored_slides: JSON.parse(this.section_sliders),
                stored_slides: this.getSlides(),
                // stored_slides:[],
                slide: {
                    url: APP_URL,
        ...
        methods: {
            getSlides: function() {
                if (this.section_sliders) {
                    return JSON.parse(this.section_sliders)
                } else {
                    return []
                }
            },
