                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-8 push-lg-2">
                            <div class="dc-sectionhead dc-text-center">
                                <div class="dc-sectiontitle">
                                    <h2 :style="{color:howWork.titleColor}" v-if="howWorkContent.content && howWorkContent.content.title">
                                        <span :style="{color:howWork.subtitleColor}" v-if="howWorkContent.content && howWorkContent.content.subtitle">{{ howWorkContent.content.subtitle }}</span>
                                        {{ howWorkContent.content.title }}
                                    </h2>
                                </div>
                                <div class="dc-description" v-html="howWorkContent.content.hw_desc" v-if="howWorkContent.content && howWorkContent.content.hw_desc"></div>
                            </div>
                        </div>
                    </div>
                </div>
