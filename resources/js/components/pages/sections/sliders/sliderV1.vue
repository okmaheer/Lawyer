        ...
        <div id="dc-homeslider" class="dc-homeslider">
            <div id="dc-bannerslider" class="dc-bannerslider carousel slide" data-ride="false" data-interval="false">
                ...
                <div class="carousel-inner">
                    <div :class="[(index+1) == 1 ? 'active':'' ,'carousel-item']" :id="'carousel-item-'+(index+1)" v-for="(sliderItem,index) in slides.slides.slide" :key="index">
...
export default {
    props:['parent_index', 'element_id', 'slider_section', 'pageID', 'slides', 'filtersApplied'],
    components:{carousel},
    data() {
        return {
            isActive:false,
