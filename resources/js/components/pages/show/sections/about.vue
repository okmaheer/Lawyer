          ...
          <div class="dc-bringcarecontent">
            <div class="dc-sectionhead dc-sectionheadvtwo">
              <div class="dc-sectiontitle">
                <h2 :style="titleStyle">
                  {{ about.title }}
                  <span :style="subtitleStyle">{{ about.subtitle }}</span>
                </h2>
              </div>
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-6">
          <div class="dc-bringimg-holder">
            <figure class="dc-doccareimg" v-if="about.image.url">
              ...
              <figcaption>
                <div class="dc-doccarecontent">
                  <h3 :style="{color:about.image.titleColor}">
                    <em :style="{color:about.image.subtitleColor}">{{ about.image.subtitle }}</em>
                    {{ about.image.title }}
                  </h3>
                </div>
            ...
            <figure class="dc-doccareimg" v-else>
              <img :src="baseUrl+'/images/img-sec-placeholder.jpg'" alt="img description" />
              <figcaption>
    ...
    <div class="after-about-section">
      <figure v-if="about.afterSection">
        <img
          ...
          v-if="pageID"
        />
        <img :src="tempUrl+about.afterSection" alt="img description" v-else />
      </figure>
    </div>
  </section>
</template>
