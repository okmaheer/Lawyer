                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-4 float-left" v-for="(item, index) in articles" :key="index">
                        <div class="dc-article">
                            ...
                            <div class="dc-articlecontent">
                                <div class="dc-title">
                                    <div class="dc-articleby-holder" v-if="item.article.cat">
                                        <a 
                                            class="dc-articleby"
                                            v-for="(category, index) in item.article.cat" :key="index"
                                            :href="category.url" 
                                        >
                                            {{ category.title }}
                                        </a>
                                    </div>
                                    <h3><a :href="item.article.slug">{{ item.article.title }}</a></h3>
                                    <span class="dc-datetime">
                                        <i class="ti-calendar"></i> 
                                        {{ item.article.create_at }}
                                    </span>
                                </div>
