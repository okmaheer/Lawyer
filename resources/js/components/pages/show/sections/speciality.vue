        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-9">
                    <div class="row">
                        <doctor-slider :doctors="speciality.detail.doctors" :speciality_title="speciality.detail.title" v-if="slider_active"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    created: function() {
        ...
        setTimeout(function(){ 
            ...
            if (self.speciality_section[index]) {
                self.speciality_section[index].detail = []
