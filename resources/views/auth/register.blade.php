...
@php
    ...
    $selected_registration_type = !empty($register_form) && !empty($register_form['registration_type']) ? $register_form['registration_type'] : 'multiple';
                    ...
                    <div class="dc-registerformmain">
                        <div class="dc-joinforms">
                            @if ($selected_registration_type == 'single')
                                <form method="POST" class="dc-formtheme dc-formregister" @submit.prevent="checkSingleForm" id="register_form">
                                    @csrf
                                    ...
                                    <fieldset class="dc-termsconditions">
                                        <div class="dc-checkboxholder">
                                            ...
                                            <a href="#" @click.prevent="checkSingleForm('{{ trans('lang.email_not_config') }}')" class="dc-btn">{{{ trans('lang.submit') }}}</a>
                                        </div>
                                    </fieldset>
                                </form>
                            @else 
