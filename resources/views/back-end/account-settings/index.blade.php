                ...
                <div class="dc-dashboardbox dc-dashboardtabsholder dc-accountsettingholder">
                    <div class="dc-dashboardtabs">
                        <ul class="dc-tabstitle nav navbar-nav">
                            ...
                            @endif
                            @if (Helper::getAuthRoleType() != 'admin' && Auth::user()->user_verified == 0)
                                <li class="nav-item">
                                    <a data-toggle="tab" href="#dc-email-verify">{{{ trans('lang.email_verification') }}}</a>
                                </li>
                            @endif
                        </ul>
                    </div>
                    <div class="dc-tabscontent tab-content">
                        ...
                        @if (Auth::user()->user_verified == 0)
                            <div class="dc-securityhold tab-pane la-section-settings" id="dc-email-verify">
                                @include('back-end.account-settings.email-verification.index')
                            </div>
                        @endif
                    </div>
                </div>
