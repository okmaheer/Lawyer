                        ...
                        {!! Form::open(['url' => url('admin/email-templates/filter-templates'), 'method' => 'get', 'class' => 'dc-formtheme dc-formsearch la-mailfilter', 'id'=>'template_filter_form']) !!}
                            <div class="form-group">
                                <span class="dc-select">
                                    {!! Form::select('role', array_map('strtoupper', $roles) ,$selected_role, array('class' => 'email-dropdown', 'placeholder' => trans('lang.filter_by_roles'), '@change'=>'submitTemplateFilter')) !!}
                                </span>
                            </div>
                        {!! Form::close() !!}
                    </div>
