                                    ...
                                    <tr class="del-{{{ $location->id }}}">
                                        ...
                                        <td data-th="Icon">
                                            <span class="bt-content">
                                                <figure>
                                                    <img src="{{{ asset(Helper::getImage('uploads/locations', $location->flag, '', 'location-default.png')) }}}" alt="{{{ html_entity_decode(clean($location->title)) }}}">
                                                </figure>
                                            </span>
                                        </td>
                                ...
                                <div class="form-group">
                                    <span class="dc-select">
                                        <select class="form-control" name="parent_location">
                                            ...
                                            @php Helper::displayLocationChild(); @endphp
                                        </select>
                                    </span>
                                </div>
                            @endif
