                ...
                <div class="dc-dashboardbox dc-dashboardtabsholder">
                    <div class="dc-dashboardtabs">
                        <ul class="dc-tabstitle nav navbar-nav">
                            ...
                            <li class="nav-item" v-on:click="displayMenuSettings">
                                <a class="" data-toggle="tab" href="#dc-menu">{{ trans('lang.menu_settings') }}</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="" data-toggle="tab" href="#dc-homepage">{{ trans('lang.homepage_settings') }}</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="dc-tabscontent tab-content">
                        ...
                        <div class="dc-personalskillshold tab-pane fade show" id="dc-homepage">
                            @include('back-end.admin.settings.general.homepage-settings')
                        </div>
                        ...
                        <div class="dc-personalskillshold tab-pane fade show" id="dc-menu">
                            @include('back-end.admin.settings.general.menu-settings')
                        </div>
                    </div>
                </div>
            </div>
