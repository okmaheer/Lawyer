            ...
            <div class="dc-clinics">
                <div>
                    <figure class="dc-clinicsimg">
                        @if ($location->user_id == $location->doctor_id && !empty($default_location) && !empty($default_location['location_img'])) 
                            <img src="{{ asset(Helper::getImage('uploads/users/'.$location->doctor_id, $default_location['location_img'], 'small-', 'user.jpg')) }}" alt="{{ trans('lang.img_desc') }}">
                        @else
                            <img src="{{ asset(Helper::getImage('uploads/users/'.$location->hospital->id, $location->hospital->profile->avatar, 'small-', 'user.jpg')) }}" alt="{{ trans('lang.img_desc') }}">
                        @endif
                ...
                <div class="dc-clinics-content">
                    <div class="dc-clinics-title">
                        @if ($location->user_id == $location->doctor_id && !empty($default_location) && !empty($default_location['location_title']))
