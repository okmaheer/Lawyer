                ...
                <div class="dc-dashboardbox dc-dashboardtabsholder">
                    ...
                    <div class="dc-dashboardtabs">
                        <ul class="dc-tabstitle nav navbar-nav">
                            ...
                            <li class="nav-item"><a data-toggle="tab" href="#dc-private-location" class="">{{ trans('lang.private_location') }}</a></li>
                        </ul>
                    </div>
                    <div class="dc-tabscontent tab-content">
                        ...
                        <div class="dc-private-location tab-pane fade" id="dc-private-location">
                            @include('back-end.doctors.profile-settings.private-clinic.location')
                        </div>
                    </div>
                </div>
            </div>
