    ...
    <div class="dc-formtheme dc-userform">
        <fieldset>
            ...
            <div class="form-group">
                {!! Form::number( 'personal_mob_num', e($personal_mob_num) ?? '', ['class' =>'form-control', 'placeholder' => trans('lang.personal_mob_num')] ) !!}
            </div>
            <div class="form-group">
            ...
            <fieldset>
                <div class="form-group la-radio-holder">
                    <span class="dc-radio">
                        ...
                        {!! Form::label('working_time', trans('lang.24_hours'), array()) !!}
                    </span>
                    <span class="dc-radio">
            ...
            <fieldset>
                <div class="form-group dc-checkbox-holder">
                    @foreach (Helper::getAppointmentDays() as $key => $day)
                        @php
                            $selected_days = in_array($key, $available_days) ? 'checked' : '' ; 
                        @endphp
                        <span class="dc-checkbox">
                            <input id="{{ $key }}-day" type="checkbox" name="days[]" value="{{ html_entity_decode(clean($key)) }}" {{$selected_days}}>
